/******************************************************************************
 * @file     vio_STM32L4R9I-DISCO.c
 * @brief    Virtual I/O implementation for board STM32L4R9I-DISCO
 * @version  V1.0.0
...
/*! \page vio_STM32L4R9I-DISCO Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED green       (LD2)     | PH4
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTH(4),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
